    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('locked_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='experts.expert')),
