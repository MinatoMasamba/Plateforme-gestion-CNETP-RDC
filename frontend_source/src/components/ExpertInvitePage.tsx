    ...
    <div className="min-h-screen bg-[#020204] font-sans text-slate-300 relative overflow-hidden flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="w-full max-w-2xl relative z-10 my-8">
        ...
        <div className="bg-[#06060c]/80 border border-white/5 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-indigo-500/20 via-indigo-400 to-blue-500/20" />
          ...
          <AnimatePresence mode="wait">
            ...
            {activeStep === "success" && (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-blue-500/20 border border-blue-500/30 flex items-center justify-center mx-auto shadow-[0_0_40px_rgba(16,185,129,0.3)]">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-blue-400 text-xs font-bold font-mono uppercase tracking-widest">
                ...
                <div className="pt-4 max-w-sm mx-auto">
                  <button
                    ...
                    className="w-full py-3.5 bg-blue-500 text-black hover:bg-blue-400 font-extrabold uppercase tracking-widest text-xs rounded-xl flex items-center justify-center gap-2 cursor-pointer shadow-lg"
                  >
