      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <motion.div 
            ...
            className="w-16 h-16 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-5 shadow-[0_0_30px_rgba(16,185,129,0.15)]"
          >
            <FileText className="w-8 h-8 text-blue-400" />
          </motion.div>
          <h1 className="text-3xl font-bold text-white tracking-widest uppercase text-center mb-2">CNETP</h1>
          <p className="text-blue-500/80 text-[11px] font-bold uppercase tracking-[0.2em] text-center">Portail d'Accès</p>
        </div>
        ...
        <div className="bg-[#06060c]/80 border border-white/5 rounded-3xl p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)]">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="block w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/40 transition-all text-sm font-medium"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="block w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/40 transition-all text-sm font-medium tracking-widest"
                  placeholder="••••••••"
                  required
                />
              </div>
          ...
          <div className="mt-8 text-center bg-white/5 -mx-8 -mb-8 p-5 border-t border-white/5">
            <p className="text-[11px] text-slate-400">
              ...
              <Link to="/auth/register/" className="text-blue-400 hover:text-blue-300 font-bold transition-colors uppercase tracking-wider ml-1">
                Créer un profil
              </Link>
            </p>
          </div>
