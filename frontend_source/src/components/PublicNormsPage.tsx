...
export default function PublicNormsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020204] font-sans text-slate-300 relative overflow-hidden flex flex-col">
      {/* Background patterns */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 via-black to-slate-900/15 pointer-events-none" />
      ...
      <AnimatePresence>
        {toastMessage && (
          <motion.div 
            ...
            className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-4 rounded-xl shadow-2xl border bg-[#040c06] border-blue-500/30 max-w-md"
          >
            <CheckCircle2 className="h-5 w-5 text-blue-400 shrink-0 shadow-[0_0_15px_rgba(16,185,129,0.3)]" />
            ...
            {!selectedNorm ? (
                ...
                {filteredNorms.length === 0 ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {filteredNorms.map(norm => (
                      ...
                      >
                        {/* Status tag */}
                        <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-teal-500/30 via-blue-400/80 to-teal-500/20" />
              ...
              >
                ...
                <div className="bg-black/60 border border-white/10 rounded-3xl p-6 sm:p-8 relative overflow-hidden backdrop-blur-md space-y-6 shadow-2xl">
                  <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-teal-500/30 via-blue-400 to-teal-500/30" />
