        ...
        <form onSubmit={handleApply} className="flex-1 overflow-y-auto p-6 space-y-6 text-xs text-slate-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <h4 className="text-[10px] font-bold text-blue-400 uppercase tracking-widest border-b border-white/5 pb-1">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8.5 p-2 bg-black/40 border border-white/10 rounded-lg text-white font-semibold focus:outline-hidden focus:border-blue-500/50"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8.5 p-2 bg-black/40 border border-white/10 rounded-lg text-white font-mono focus:outline-hidden focus:border-blue-500/50"
                    />
                  </div>
                </div>
                  ...
                  return (
                    <div 
                      ...
                      className={`p-3 border rounded-xl transition-all cursor-pointer flex gap-3 items-start ${
                        isSelected 
                          ? `${role.colorClass} scale-[1.01] ring-1 ring-blue-500/20` 
                          : "border-white/5 bg-white/[0.01] hover:bg-white/[0.03] text-slate-400"
                      }`}
                    >
                      <div className="mt-0.5 shrink-0">
                        <div className={`h-4.5 w-4.5 rounded-full border flex items-center justify-center ${
                          isSelected ? "border-blue-400 text-blue-400" : "border-slate-700"
                        }`}>
          ...
          <div className="pt-4 border-t border-white/10 flex justify-end gap-3 bg-black/20 p-4 -mx-6 -mb-6">
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-blue-500 hover:bg-blue-400 text-black font-extrabold rounded-lg tracking-wide uppercase transition-all cursor-pointer flex items-center gap-1.5 shadow-md"
            >
