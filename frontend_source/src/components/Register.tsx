...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res: any = await apiPost('/api/v1/auth/register/', { 
        username, 
        email, 
  ...
  return (
    <div className="min-h-screen bg-[#020204] font-sans text-slate-300 relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 via-black to-slate-900/20 pointer-events-none" />
      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          <motion.div 
            ...
            className="w-14 h-14 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center mb-4 shadow-[0_0_30px_rgba(16,185,129,0.15)]"
          >
            <FileText className="w-6 h-6 text-blue-400" />
          </motion.div>
          <h1 className="text-2xl font-bold text-white tracking-widest uppercase text-center mb-1">CNETP</h1>
          <p className="text-blue-500/80 text-[10px] font-bold uppercase tracking-[0.2em] text-center">Bureau d'Accès Public</p>
        </div>
        ...
        <div className="bg-[#06060c]/80 border border-white/5 rounded-3xl p-6 sm:p-8 backdrop-blur-xl shadow-2xl relative overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-blue-500/20 via-blue-400/80 to-teal-500/20" />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="block w-full pl-10 pr-3 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/40 transition-all text-sm font-medium"
                    placeholder="Pseudo"
                    required
                  />
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    className="block w-full pl-10 pr-3 py-2.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/40 transition-all text-sm font-medium tracking-widest"
                    placeholder="••••••••"
                    required
                  />
                </div>
            ...
            <div className="pt-4">
              <motion.button 
                ...
                className="w-full py-3.5 bg-blue-500 text-black rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-blue-400 shadow-[0_4px_20px_rgba(16,185,129,0.2)] hover:shadow-[0_4px_25px_rgba(16,185,129,0.35)] transition-all flex items-center justify-center gap-2.5 disabled:opacity-50 disabled:hover:bg-blue-500 disabled:shadow-none disabled:cursor-not-allowed"
          ...
          <div className="mt-8 text-center bg-white/5 -mx-6 sm:-mx-8 -mb-6 sm:-mb-8 p-5 border-t border-white/5">
            <p className="text-[11px] text-slate-400">
              Déjà un compte ?{' '}
              <Link to="/auth/login/" className="text-blue-400 hover:text-blue-300 font-bold transition-colors uppercase tracking-wider ml-1">
                Se Connecter
              </Link>
            </p>
          </div>
