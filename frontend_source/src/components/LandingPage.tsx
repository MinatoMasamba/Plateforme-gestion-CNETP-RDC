...
export const Landing: React.FC = () => {
  ...
  const modules = [
    ...
    { icon: <Users className="w-8 h-8" />, name: "Réseau d'Experts", desc: "Un annuaire exclusif regroupant les plus grands ingénieurs, chercheurs et légistes de la nation.", color: "text-blue-400 bg-blue-500/10 border-blue-500/20" },
  ...
  const profiles = [
    {
      icon: <Briefcase className="w-10 h-10 mb-4 text-blue-400 bg-blue-500/10 p-2 rounded-xl border border-blue-500/20" />,
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              ...
              Plateforme Ouverte • Version 1.0
            </motion.div>
            
            <h1 className="text-5xl sm:text-7xl font-bold text-white mb-8 leading-[1.1] tracking-tight">
              Centraliser la Création des <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-300">Normes Nationales</span>
            </h1>
